...
function DownloadApk() {
  return (
    <section className="w-full py-10 md:py-20 px-5 md:px-6">
     <div className="max-w-7xl mx-auto p-5 md:p-8 rounded-[22px] md:rounded-2xl"
        style={{
          ...
          <div>
            ...
            <div className="flex gap-3 md:gap-4">
              <button className="flex items-center gap-2 rounded-xl hover:scale-105 transition">
                <img src="/images/buttons/apple-button.png" className="w-[115px] md:w-32" alt="App Store" />
              </button>
              <button className="flex items-center gap-2 rounded-xl hover:scale-105 transition">
                <img src="/images/buttons/play-button.png" className="w-[120px] md:w-34" alt="Google Play" />
              </button>
            </div>
          </div>
          ...
          {loading ? (
            ...
            faqs.map((item, index) => (
              <div key={index} className="border-b border-gray-200 pb-4 md:pb-6">
                ...
                >
                  <h4 className="text-[14px] md:text-base font-semibold text-gray-900 pr-3 leading-6">{item.q}</h4>
                  <span
                ...
                >
                  <p className="text-[13px] md:text-base text-gray-600 leading-6 md:leading-relaxed">{item.a}</p>
                </div>
              </div>
            ))
          )}
